...
<?php
    ...
    if(isset($_SESSION['D_id'])){
        $user = get_doctortable_info($con, $_SESSION['D_id']);
    }
        ...
        <div class="col-lg-4 offset-lg-2">
            ...
            <div class="upload-profile-image d-flex justify-content-center pb-5">
                <div class="text-center">
                    <img src="<?php echo isset($doctortable['profileImage']) ? $doctortable['profileImage'] : './assets/profile/beard.png' ; ?>" style="width: 200px; height: 200px" class="img rounded-circle" alt="profile">
                </div>
            </div>
